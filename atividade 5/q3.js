...
// divisível por 4. Entretanto, se o ano é divisível por 100, ele não é bissexto. Mas, se ele for divisível por 400, ele volta a ser bissexto.
...
const ano = parseInt(prompt('Insira o ano para saber se é bissexto ou não.'))
        if(ano % 4 == 0){
            alert('Ano bissexto com 366 dias')
        } else {
            alert('Ano comun, com 365 dias')
        }